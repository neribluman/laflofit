...
| Screen | What's on it |
|---|---|
| **Today** | Your plan's rules as a checklist, a day score, a streak, and the last 7 days at a glance. **Tap the date to jump to any past day** — everything on the screen then reads and writes that day, so a forgotten Tuesday can be filled in on Friday. |
